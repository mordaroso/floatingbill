...
class User < ActiveRecord::Base
  ...
  #validates_inclusion_of    :default_currency, :in => CurrencySystem::CURRENCY_NAMES
  ...
  attr_accessible :login, :email, :name, :password, :password_confirmation, :default_currency
